	...
	*/	
	...
	if( !function_exists('gdlr_hotel_mail_content') ){
		function gdlr_hotel_mail_content($contact, $data, $payment_info, $price){
			...
			$content .= __("Country :", "gdlr-hotel") . " {$contact['country']}\n";
			$content .= __("City :", "gdlr-hotel") . " {$contact['city']}\n";
			$content .= __("State :", "gdlr-hotel") . " {$contact['state']}\n";
			$content .= __("Street :", "gdlr-hotel") . " {$contact['street']}\n";
	...
	if( !function_exists('gdlr_insert_booking_db') ){
		function gdlr_insert_booking_db($options){
			...
			// TODO : We can implement CRM calling API in here
