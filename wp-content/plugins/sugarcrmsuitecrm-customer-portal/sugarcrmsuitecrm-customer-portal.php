...
function sugar_crm_portal_signup( $html = "" ) {
    ...
    $current_url = $current_url[0]; 
        ...
        /*if(isset($_REQUEST['add-sign-up']) == true) {
			...
			if($sugar_crm_version == 7) {
				echo '<script>window.location.href="'.home_url().'/demo/?signup=true"</script>';
			}else{
        ...
        <div class='scp-form scp-form-two-col'>
            <form action='".site_url()."/wp-admin/admin-post.php' method='post'>
                <ul>
                    ...
                    <li class='scp-send'>
                    <input type='hidden' name='action' value='scp_forgot_password'><!--updated on 09-nov-2015-->
                                <input type='hidden' name='scp_current_url' value='".$current_url."'>
                            ...
                            $html .= "<div class='scp-entry-header'>
                                <h3>Show All Cases</h3>"; 
                                    ...
                                    if($sugar_crm_version == 6) {
                                        ...
                                        else {//Updated by ketul on 06-nov-2015
                                            //$order_by = "";    
                                            $order_by = "id:DESC";    
                                        }
                                        
                                        $getAllCases = $objSCP->getRelatedCasefor_LoggedContact($_SESSION['scp_user_id'], '', '',$order_by);
                                        //Added by ketul on 06-nov-2015
                                        $getAllCases_with_limit = $objSCP->getRelatedCasefor_LoggedContact($_SESSION['scp_user_id'], $limit, $offset,$order_by);
                                        $cnt =  count($getAllCases_with_limit->records);
                                        //$countCases = count($objSCP->getRelatedCasefor_LoggedContact_Count($_SESSION['scp_user_id'])->records);
                                        //Updated by ketul on 06-nov-2015
                                        $countCases = count($getAllCases->records);
                                        ...
                                        if($cnt != NULL){                                      
                                            ...
                                            //Updated by ketul on 06-nov-2015  
                                            foreach($getAllCases_with_limit->records as $setAllCases) {  
